...
const Calculator = {
    ...
    //this will hold the operator, we set it ti null for now
    operator: null,
};

// this modifies values each time a butoon is clicked
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator alrerady exist and if wait_Second_Operand is true,
    ...
    if (First_Operand == null) {
        ...
        //if operator exist, property lookup is performed for the opertator
        //in the perform_Calculation object and the function that matches the
        //operator is executed
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        //here we add a fixed amountof numbers after the decimal
